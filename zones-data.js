...
// Source: https://www.pokebip.com/page/jeux-video/pokemon-ultra-soleil-ultra-lune/guide-des-lieux/index
const ZONES_DATA = [
    // ═══════════════════════════════════════════════════════════════
    // MELE-MELE (Île 1)
    // ═══════════════════════════════════════════════════════════════
    {id: "route1", name: "Route 1", island: "Mele-Mele", islandNum: 1},
    {id: "route1_grass", name: "Route 1 (Herbes hautes)", island: "Mele-Mele", islandNum: 1},
    {id: "lili_town", name: "Lili'i", island: "Mele-Mele", islandNum: 1},
    ...
    {id: "beach_cave", name: "Grotte de la Plage", island: "Mele-Mele", islandNum: 1},
    {id: "big_wave_beach", name: "Plage Big Wave", island: "Mele-Mele", islandNum: 1},
    ...
    {id: "royal_avenue", name: "Rue du Dôme Royal", island: "Akala", islandNum: 2},
    {id: "route7", name: "Route 7", island: "Akala", islandNum: 2},
    {id: "wela_volcano", name: "Parc Volcanique (Volcan Wela)", island: "Akala", islandNum: 2},
    ...
    {id: "fossil_lab", name: "Laboratoire d'Étude des Fossiles", island: "Akala", islandNum: 2},
    ...
    {id: "hoohale_beach", name: "Plage de Ho'ohale", island: "Akala", islandNum: 2},
    {id: "hano_beach", name: "Plage de Hano", island: "Akala", islandNum: 2},
    {id: "hano_resort", name: "Club Hano-Hano", island: "Akala", islandNum: 2},
    {id: "pikachu_valley", name: "Plaine des Pikachu", island: "Akala", islandNum: 2},
    ...
    {id: "malie_garden", name: "Parc de Malié", island: "Ula-Ula", islandNum: 3},
    ...
    {id: "secluded_shore", name: "Plage d'Ula-Ula", island: "Ula-Ula", islandNum: 3},
    ...
    {id: "ruins_abundance", name: "Ruines de l'Essor", island: "Ula-Ula", islandNum: 3},
    {id: "tapu_village", name: "Village Toko", island: "Ula-Ula", islandNum: 3},
    {id: "route14", name: "Route 14", island: "Ula-Ula", islandNum: 3},
    {id: "thrifty_megamart", name: "Bradley Prix désaffecté", island: "Ula-Ula", islandNum: 3},
    ...
    {id: "ula_ula_meadow", name: "Jardin d'Ula-Ula", island: "Ula-Ula", islandNum: 3},
    ...
    {id: "outer_cape", name: "Cap Passiloin", island: "Ula-Ula", islandNum: 3},
    ...
    {id: "lake_of_moone", name: "Lac du Halo Lunaire", island: "Ula-Ula", islandNum: 3},
    {id: "lake_of_sunne", name: "Lac du Halo Solaire", island: "Ula-Ula", islandNum: 3},
    ...
    {id: "poni_wilds", name: "Forêt de Poni", island: "Poni", islandNum: 4},
    ...
    {id: "ruins_of_hope", name: "Ruines de l'Au-Delà", island: "Poni", islandNum: 4},

    // ⚔️ COMBAT #10
    {id: "battle_10", name: "⚔️ COMBAT #10", island: "Poni", islandNum: 4, isBattle: true, rules: "5v5", description: "Après les Ruines de l'Au-Delà"},
    ...
    {id: "altar_sunne_moone", name: "Autel du Soleil/Lune", island: "Poni", islandNum: 4},

    // ⚔️ COMBAT #11
    {id: "battle_11", name: "⚔️ COMBAT #11", island: "Poni", islandNum: 4, isBattle: true, rules: "5v5", description: "Après le Grand Canyon de Poni"},

    {id: "poni_grove", name: "Jardin de Poni", island: "Poni", islandNum: 4},
    {id: "poni_plains", name: "Plaine de Poni", island: "Poni", islandNum: 4},
    {id: "plains_cave", name: "Grotte de la Plaine", island: "Poni", islandNum: 4},
    ...
    {id: "poni_reef", name: "Récif de Poni", island: "Poni", islandNum: 4},
    {id: "poni_sea", name: "Mer de Poni", island: "Poni", islandNum: 4},
    {id: "battle_tree", name: "Arbre de Combat", island: "Poni", islandNum: 4},
    ...
    // ═══════════════════════════════════════════════════════════════
    // ZONES SPÉCIALES (Post-game / Accessibles pendant l'aventure)
    // ═══════════════════════════════════════════════════════════════
    {id: "aether_paradise", name: "Paradis Æther", island: "Spécial"},
    {id: "rocket_castle", name: "Château Rocket", island: "Spécial"},
    ...
    // ═══════════════════════════════════════════════════════════════
    // PÊCHE (Zones spécifiques)
    // ═══════════════════════════════════════════════════════════════
    {id: "fishing_melemele", name: "Pêche Mele-Mele", island: "Pêche"},
    {id: "fishing_akala", name: "Pêche Akala", island: "Pêche"},
    {id: "fishing_ulaula", name: "Pêche Ula-Ula", island: "Pêche"},
